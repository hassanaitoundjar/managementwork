...
const resources = {
  ...
  es: {
    translation: {
      ...
      totalWorkedDays: "Días Trabajados Totales",
      totalEarnings: "Ganancias Totales",
      last15Days: "Últimos 15 Días",
      currentMonth: "Mes Actual",
      noEmployees: "No hay empleados agregados aún",
      addFirstEmployee: "Agrega tu primer empleado para comenzar",
      ...
      confirmDelete: "¿Estás seguro de que quieres eliminar este empleado?",
      workCalendar: "Calendario de Trabajo",
      addWorkDay: "Agregar Día de Trabajo",
      ...
      noClients: "No hay clientes agregados aún",
      ...
      rateRequired: "La tarifa diaria es requerida",
      rateInvalid: "Por favor ingresa una tarifa válida",
      contactRequired: "La información de contacto es requerida",
      ...
      workDayAdded: "Día de trabajo agregado exitosamente",
      workDayUpdated: "Día de trabajo actualizado exitosamente",
      settingsSaved: "Configuración guardada exitosamente",

      // Additional translations
      day: "día",
      companyName: "Shihabfalling",
      employeeManagement: "Sistema de Gestión de Empleados",
      appSettings: "Configuración de la App",
      light: "Claro",
      dark: "Oscuro",
      themeLabel: "Tema",
      welcomeTo: "Bienvenido a tu",
      configureYour: "Configura tu",
      locationRequired: "La ubicación es requerida",
      failedToChangeLanguage: "Error al cambiar idioma",
      failedToChangeTheme: "Error al cambiar tema",
      failedToSaveClient: "Error al guardar cliente",
      failedToDeleteClient: "Error al eliminar cliente",
      businessClient: "Cliente Empresarial",
      thisMonth: "Este Mes",
      earnings: "Ganancias",
      advances: "Adelantos",
      ...
      location: "Ubicación",
      dailyAdvance: "Adelanto Diario",
      advanceAmount: "Monto del Adelanto",
      enterAdvanceAmount: "Ingresa el monto del adelanto",
      advanceNote: "Este adelanto será deducido de las ganancias mensuales",
    },
  },
  ar: {
    translation: {
