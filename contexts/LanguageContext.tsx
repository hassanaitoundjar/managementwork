...
const resources = {
  en: {
    translation: {
      ...
      allDayWork: "All Day Work",
      morningHours: "Morning Hours",
      eveningHours: "Evening Hours",
      enterMorningHours: "Enter morning hours",
      enterEveningHours: "Enter evening hours",
      legacy: "Legacy",
    },
  },
  ar: {
    translation: {
      ...
      workShifts: "نوبات العمل",
      morningShift: "نوبة الصباح",
      eveningShift: "نوبة المساء",
      allDayWork: "عمل طوال اليوم",
      morningHours: "ساعات الصباح",
      eveningHours: "ساعات المساء",
      enterMorningHours: "أدخل ساعات الصباح",
      enterEveningHours: "أدخل ساعات المساء",
      legacy: "قديم",
    },
  },
  fr: {
    translation: {
      ...
      workShifts: "Équipes de Travail",
      morningShift: "Équipe du Matin",
      eveningShift: "Équipe du Soir",
      allDayWork: "Travail Toute la Journée",
      morningHours: "Heures du Matin",
      eveningHours: "Heures du Soir",
      enterMorningHours: "Entrez les heures du matin",
      enterEveningHours: "Entrez les heures du soir",
      legacy: "Ancien",
    },
  },
};
